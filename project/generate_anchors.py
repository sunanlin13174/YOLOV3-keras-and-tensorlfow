...
saveBasePath ="/raid/my_data/ImageSets"              # txt文件保存目录
total_xml = os.listdir('/raid/my_data/Annotations')   # 获取标注文件（file_name.xml）
...
f = open('./model_data/demo.names', 'r').readlines()      #classes names in order  , because you need to extract obj names index in anno
...
data_file='/raid/my_data'
# voc_12 = '/data/VOCdevkit/VOC2012'

anno_path = [os.path.join(data_file, 'Annotations')]   #annotations
img_path = [os.path.join(data_file, 'JPEGImages')]     #images

trainval_path = [os.path.join(data_file, 'ImageSets/Main/trainval.txt')]
test_path = [os.path.join(data_file, 'ImageSets/Main/test.txt')]
